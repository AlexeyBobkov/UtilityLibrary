...
namespace AAB.UtilityLibrary
{
    ...
    public interface IProfile
    {
        ...
        object GetValue(string section, string entry, object defaultValue);
        object GetValue(string section, string entry, object defaultValue, Type type);
    ...
    public class XmlProfile : IProfile
    {
        ...
        public virtual object GetValue(string section, string entry, object defaultValue)
        {
            return DoGetValue(section, entry, defaultValue != null ? defaultValue.GetType() : null) ?? defaultValue;
        }
        public virtual object GetValue(string section, string entry, object defaultValue, Type type)
        {
